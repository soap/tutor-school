                            ...
                            <div role="tabpanel" class="tab-pane active" id="profile">
                                <table class="table table-striped table-hover table-bordered dashboard-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{!! route('user.profile.edit') !!}" class="btn btn-primary btn-xs">{{ trans('labels.user.profile.edit_information') }}</a>

                                            @if ($user->id)
                                                <a href="{!! route('user.password.change') !!}" class="btn btn-warning btn-xs">{{ trans('navs.user.change_password') }}</a>
                                            @endif
                                        </td>
                                    </tr>
                                </table>
