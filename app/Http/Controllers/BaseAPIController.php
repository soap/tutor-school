...
use App\School\Serializers\ArraySerializer;
 ...
 * @SWG\Swagger(
 *     schemes={"http","https"},
 *     host="tutorschool.dev",
 *     basePath="/api/v1",
 *     @SWG\Info(
 *         version="1.0.0",
 *         title="Tutor School API",
 *         description="An open-source tutor school management application built with Laravel",
 *         termsOfService="",
 *         @SWG\Contact(
 *             email="contact@edutechinnovations.com"
 *         ),
 *         @SWG\License(
